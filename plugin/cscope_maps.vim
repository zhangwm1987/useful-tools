...
if has("cscope")
    ...
    "unshow msg when cscope db is added at first time
    set nocsverb
    "show 4 levels of file directory
    set cspc=4

    "config quickfix:except global definition search
    if v:version >= 602 
        set cscopequickfix=s-,f-,d-,c-,t-,e-,i-
    endif
...
"jump back
nmap b <C-t>
"open/close quickfix window for cscope
cab co copen
cab cc cclose

" Find this C symbol
"map \s :cscope find s =expand(""):copen
cab css cscope find s

" Find this global definition:
"map \g :cscope find g =expand(""):copen
cab csg cscope find g

" Find functions called by this function:
"map \d :cscope find d =expand(""):copen
cab csd cscope find d

" Find functions calling this function:
"map \c :cscope find c =expand(""):copen
cab csc cscope find c

" Find this text string:
"map \t :cscope find t =expand(""):copen
...
"map \e :cscope find e =expand(""):copen
cab cse cscope find e

" Find this file:
"map \f :cscope find f =expand(""):copen
cab csf cscope find f

" Find files #including this file:
"map \i :cscope find i ^=expand("")$:copen
...
"-------------------------------------------------- 
"<Leader>='\', so \\s means cs find s 'word' which is under the cursor
